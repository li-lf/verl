                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if (
                            ...
                            # Add step and checkpoint_dir to batch meta_info for rejected sample logging
                            if batch.meta_info is None:
                                batch.meta_info = {}
                            batch.meta_info["step"] = self.global_steps
                            batch.meta_info["checkpoint_dir"] = self.config.trainer.get("default_local_dir", os.getcwd())
