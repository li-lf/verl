...
#   algorithm.rollout_correction.log_rejected_samples=true  # Optional: log rejected samples to JSON
#   algorithm.rollout_correction.log_rejected_samples_path=null  # Optional: custom path (default: {checkpoint_dir}/rejected_samples_step_{step}.json)
